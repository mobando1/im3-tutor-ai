...
<body>
  <div class="container">
    <div class="logo">🎓</div>
    <h1>IM3 Tutor</h1>
    <p class="subtitle">Tutor virtual con IA — en vivo y en tiempo real</p>
    <div class="status">
      <span class="status-dot"></span>
      API activa
    </div>
    <div class="card">
      <h3>Integrar widget</h3>
      <code>&lt;script
  src="${"https://tutor.im3systems.com"}/widget.js"
  data-tutor="TUTOR_ID"
  data-theme="light"
...
&lt;/script&gt;</code>
    ...
    <div class="card">
      <h3>Endpoints</h3>
      <code>GET  /health
GET  /api/tutor/:id/config
POST /api/tutor/:id/chat
WS   /ws/tutor</code>
    </div>
    <p class="footer">Powered by <a href="https://im3systems.com">IM3 Systems</a></p>
  </div>
</body>
</html>`);
});
